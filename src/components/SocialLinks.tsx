      ...
      <div className="flex justify-evenly grow items-center">
        ...
        >
          <svg
            ...
            fill="none"
            strokeWidth="2"
            className="stroke-1 hover:scale-110 transition-transform duration-100 ease-in tablet:w-20 tablet:h-20 phone:w-10 phone:h-10 hover:stroke-[#0077B5] hover:shadow-stand-out"
          >
            <path
        ...
        <a title="X" href="https://twitter.com/nate_sonnenberg" target="_blank">
          <svg
            ...
            fill="none"
            strokeWidth="2"
            className="stroke-1 hover:scale-110 transition-transform duration-100 ease-in tablet:w-20 tablet:h-20 phone:w-10 phone:h-10 hover:text-[#08A0E9] hover:shadow-stand-out"
          >
        ...
        >
          <svg
            ...
            fill="none"
            strokeWidth="2"
            className="stroke-1 hover:scale-110 transition-transform duration-100 ease-in tablet:w-20 tablet:h-20 phone:w-10 phone:h-10 hover:stroke-[#4267B2] hover:shadow-stand-out"
          >
        ...
        >
          <svg
            ...
            fill="none"
            strokeWidth="2"
            className="stroke-1 hover:scale-110 transition-transform duration-100 ease-in tablet:w-20 tablet:h-20 phone:w-10 phone:h-10 hover:stroke-[#2DBA4E] hover:shadow-stand-out"
          >
